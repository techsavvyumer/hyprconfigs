...
#######################################################
# My Configs Start From Here, Umer Mansoor
#######################################################
...
alias hows-my-gpu='echo "NVIDIA Dedicated Graphics" | grep "NVIDIA" && lspci -nnk | grep "NVIDIA Corporation GM107M" -A 2 | grep "Kernel driver in use:" && echo "Intel Integrated Graphics" | grep "Intel" && lspci -nnk | grep "Intel.*Integrated Graphics Controller" -A 3 | grep "Kernel driver in use:" && echo "Enable and disable the dedicated NVIDIA GPU with nvidia-enable and nvidia-disable"'
alias nvidia-enable='cd /home/umer/.scripts/ && sudo ./gpu-enable.sh'
alias nvidia-disable='cd /home/umer/.scripts/ && sudo ./gpu-disable.sh'

alias nvidia-enable1='sudo virsh nodedev-reattach pci_0000_01_00_0'
alias nvidia-enable2='echo "GPU reattached (now host ready)"'
alias nvidia-enable3='sudo rmmod vfio_pci vfio_pci_core vfio_iommu_type1'
alias nvidia-enable4='echo "VFIO drivers removed"'
alias nvidia-enable5='sudo modprobe -i nvidia_modeset nvidia_uvm nvidia'
alias nvidia-enable6='echo -e "NVIDIA drivers added\nCOMPLETED!"'

alias nvidia-disable1='sudo rmmod nvidia_modeset nvidia_uvm nvidia'
alias nvidia-disable2='echo "NVIDIA drivers removed"'
alias nvidia-disable3='sudo modprobe -i vfio_pci vfio_pci_core vfio_iommu_type1'
alias nvidia-disable4='echo "VFIO drivers added"'
alias nvidia-disable5='sudo virsh nodedev-detach pci_0000_01_00_0'
alias nvidia-disable6='echo -e "GPU detached (now vfio ready)\nCOMPLETED!"'
